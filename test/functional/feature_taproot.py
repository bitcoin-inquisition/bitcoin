...
def default_sigmsg(ctx):
    ...
    if mode == "taproot":
        ...
        if get(ctx, "leaf") is not None:
            ...
            return TaprootSignatureMsg(tx, utxos, hashtype, idx, scriptpath=True, leaf_script=script, leaf_ver=leaf_ver, codeseparator_pos=codeseppos, annex=annex, key_ver=keyver)
        else:
...
def bip348_csfs_spenders():
    ...
    if extendable_length > 0:
        EXTEND_CSFS_MSG = CSFS_MSG + random.randbytes(random.randrange(1, extendable_length + 1))
...
class TaprootTest(BitcoinTestFramework):
    ...
    def gen_test_vectors(self):
        ...
        coinbase.rehash()
        assert coinbase.hash == "2a8103d4574e66e8e2c746a4d40f2626ab084263b42c869d1b3c73f8341cc5d5"
        # Mine it
